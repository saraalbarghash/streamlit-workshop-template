...
st.set_page_config(
    page_title="لبيتك",  # ✅ تم إصلاح علامة التنصيص المفقودة هنا
    page_icon="🏠✨",
    layout="centered"
)
...
# ==================== 3. APP HEADER ====================
# ✅ تم إصلاح الكلاسات لتتطابق مع الـ CSS، وتم وضع النصوص العربية في المكان الصحيح
...
team_name = st.sidebar.text_input("اسم استوديو التصميم / المصمم", "استوديو الأناقة")
...
# INPUT 3: Text Input / Query (ملاحظات العميل أو ميزانيته)
client_notes = st.text_input(
    "📝 متطلبات خاصة أو متطلبات الإضاءة والألوان", 
    placeholder="مثال: أركز على درجات الأخضر الزيتي مع إضاءة دافئة ومساحة مكتبية..."
)
...
if st.button("✨ إنتاج التقرير المبدئي للتصميم"):
    ...
    if room_area >= 80:
        ...
        st.warning(f"📐 **مساحة ملمومة!** يُنصح باستخدام ألوان فاتحة مثل (Sage/Off-White) والمرايا لزيادة الشعور بالاتساع.")
